...
Shipped in v0.4.1 after maintainer review of the Home Hub notification,
...
the in-game phase test. See [release verification](../releases/2026-09-05-osplus-0.4.1.md),
[patch notes](../releases/0.4.1-patch-notes.md) and
