...
- **Sub-tab swap mechanism** confirmed by Stage-3 Pass-2 probe; production install pattern lives in a new `mod/OSPlus/scripts/loadouts.lua` (or extension of an existing module — Brief picks).
